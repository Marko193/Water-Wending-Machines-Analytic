...
import { Row, Col, Card, CardBody, CardTitle, Nav, NavItem, NavLink, TabContent, TabPane, CardSubtitle } from "reactstrap"
//Import Breadcrumb
...
const Apexchart = () => {
    const [activeTabJustify2, setactiveTabJustify2] = useState("26")
                                ...
                                <Nav pills>
                                    ...
                                    <NavItem className="waves-effect waves-light">
                                        ...
                                        >
                                            ...
                                            <span className="d-none d-sm-block">Сеансы</span>
                                        </NavLink>
                                    </NavItem>
                                    <NavItem className="waves-effect waves-light">
                                        <NavLink
                                        ...
                                        >
                                            ...
                                            <span className="d-none d-sm-block">Кол-во воды</span>
                                        </NavLink>
                                    </NavItem>
                                    <NavItem className="waves-effect waves-light">
                                        <NavLink
                                        ...
                                        >
                                            ...
                                            <span className="d-none d-sm-block">Доход</span>
                                        </NavLink>
                                    </NavItem>
                                </Nav>
                            ...
                            <Card>
                                <CardBody>
                                    <MDBDataTable
                                        ...
                                        esponsive striped bordered data={data}
                                    />
                                </CardBody>
                            </Card>
                        </Col>
